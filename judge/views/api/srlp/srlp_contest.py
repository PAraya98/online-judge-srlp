        ...
        if contest.ended:
            ...
            if has_locked_time:
                ...
                if has_limit_time:
                    ...
                    message = 'Tú tiempo limite termina en: '+datetime.strptime(datetime.fromtimestamp(conditional_time - timezone_now), "%d:-%H:%M:%S")  
                else:
                    conditional_time = contest.locked_after.timestamp() + 0.5
                    message = 'El concurso se bloquea en: '+datetime.strptime(datetime.fromtimestamp(conditional_time - timezone_now), "%d:-%H:%M:%S")  
            else:
                ...
                if has_limit_time:
                    ...
                    message = 'El concurso termina en: '+datetime.strptime(datetime.fromtimestamp(conditional_time - timezone_now), "%d:-%H:%M:%S")          
