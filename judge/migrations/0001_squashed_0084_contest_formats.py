    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_rank', models.CharField(max_length=14, default='Alumno', verbose_name=_('display rank'), choices=(('Administrador', _('Administrador del sitio')), ('Profesor', ('Acádemico del departamento')), ('Alumno', ('Alumno')), ('Visitante', ('Visitante'))))), 
