    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_rank', models.CharField(max_length=14, default='Alumno', verbose_name=_('display rank'), choices=(('Administrador', _('Administrador del sitio')), ('Profesor', _('Acádemico del departamento')), ('Alumno', _('Alumno')), ('Visitante', _('Visitante'))))), 
                ...
                ('is_totp_enabled', models.BooleanField(default=False, help_text='check to enable TOTP-based two factor authentication', verbose_name='2FA enabled')), ('totp_key', judge.models.profile.EncryptedNullCharField(blank=True, help_text='32 character base32-encoded key for TOTP', max_length=32, null=True, validators=[django.core.validators.RegexValidator('^$|^[A-Z2-7]{32}$', 'TOTP key must be empty or base32')], verbose_name='TOTP key')),
